      ...
      <MainContainer background="black" divideBy="5">
        ...
        <Content>
          <div className="slider-container" id="slider-two">
            <h1 className="slider-header" style={{marginBottom: "0px", marginTop: "-5vw"}}>About the slider</h1>
            {/* <div className="slider-quote">
              - Developer by day, sleeper by night!
            </div> */}
            <div className="slider-content" style={{marginTop: "0px"}}>
              This slider was created in a way so it can be turned into an
              npm package that is easy to use for other developers. It is
              completely flexible and works perfectly well in containers of all sizes and with any content.
            </div>
          </div>
        </Content>
        <Content>
          <div className="slider-container" id="slider-three">
            ...
            <ul className="slider-list-container">
              <li><strong>Responsive:</strong> Can be used in full screen or in a smaller element</li>
              <li><strong>Takes three props;</strong> background, divideBy and randomClipper</li>
              <li><strong>background:</strong> Sets the transition background as url and colors</li>
              <li><strong>divideBy:</strong> Takes a number and clips the content if divideBy amount of fractions </li>
              <li><strong>randomClipper:</strong> If true, changes the sliding animation to a more random based one</li>
            </ul>
          </div>
        </Content>
      </MainContainer>
